...
wat2<- wat+theme(legend.position = "none",
  ...
  annotate("text", x =-98, y = 19.3, label = "NPLM", size=5, fontface="bold")+ 
  annotate("text", x =-98.7, y = 19.35, label = "NPIP", size=5, fontface="bold")
...
maps_final<-ggplot() +
  ...
  annotation_custom(
    ...
    xmax = 10, ymin = 5, ymax = 12) +
  annotation_custom(
    ggplotGrob(wat2),  
    xmin = 10, xmax = 30, ymin = 9, ymax = 20) +
  annotation_custom(
    leg, xmin = 15, xmax = 28, 
    ymin = 0, ymax =9 ) +
  geom_segment(
    aes(x = 5.5, y = 9, xend = 14, yend = 12.5),
