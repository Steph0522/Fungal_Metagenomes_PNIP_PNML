...
#annotatio row (filas)
guilds<- read_tsv("../Data/guilds_all.tsv") %>% group_by(Taxon, Guild, `Trophic Mode`) %>% mutate(Guilds=case_when(
...
is.character) %>% replace(
  is.na(.), "Unassigned") %>% distinct() %>% column_to_rownames(
...
"Animal Pathogen-Endophyte-Epiphyte-Fungal Parasite-Plant Pathogen-Wood Saprotroph"="#F08080",
...
"Animal Pathogen-Undefined Saprotroph"="#C70039",
...
"Endophyte"="#00FFFF",
"Endophyte-Plant Pathogen"="#0b5345",
"Epiphyte"="#02f0a5",
