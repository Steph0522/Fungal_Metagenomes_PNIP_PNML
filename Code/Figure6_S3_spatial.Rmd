...
max.sim<-1
qiime2_data<- bc.dist.tidy.filt[[1]] %>% mutate(Method="QIIME2")
...
qiime2_data2<- bc.dist.tidy.filt2[[1]] %>% mutate(Method="QIIME2")
...
d1;d2
ggsave("Fig.spatialdistance-bray_final.jpg",width =4, height = 8, dpi = 300, plot = d1, device = "jpg")
